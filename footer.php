...
<style>
    footer > a:hover{
        color: rgba(85,88,255,0.77);
    }
</style>
<div class="py-3 container-fluid mx-sm-auto" style="background-color: #2e2e2e;">
    <footer class="pt-4 pb-2">
        <div class="row">
            <?php foreach ($getFooter as $row): ?>
                <div class="col-lg-3">
                    <h3 class="text-white mt-3 border-right border-primary border-4 ps-3 fs-5"><?= $row['title'] ?></h3>
                    <p class="text-white-50 py-3"><?= $row['text'] ?></p>
                </div>
            <?php endforeach; ?>
        ...
        <div class="text-white" style="">
            <p class="text-center mb-4 pt-2">تماس باما: 0912-312-3344</p>
        </div>
        <div class="m-auto" style="height: 48px;">
            <ul class="list-unstyled" style="height: 100%;">
                <li class="ml-4">
                    <a href="http://">
                        <i class="bi bi-telegram text-light">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
